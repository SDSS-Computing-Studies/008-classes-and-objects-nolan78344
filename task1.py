...
class student:
    ...
    def __init__(self, name, studentnumeber, gradelevel): # You will need to create your own input parameters for all methods
        self.name
        self.studentnumber
        self.gradelevel
        pass
